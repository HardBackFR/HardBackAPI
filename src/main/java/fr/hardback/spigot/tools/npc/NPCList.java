...
public enum NPCList {
    ...
    public static String SUB_TITLE = ChatColor.GRAY + "[Clic-droit]";

    NPCList(String name, String texture, String signature, Location location) {
        this.name = name;
